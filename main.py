...
img = plt.imread('data/basicSquat.jpeg')
im = img.copy()


# For static images:
IMAGE_FILES = ['data/basicSquat.jpeg']
...
with mp_pose.Pose(
  ...
  for idx, file in enumerate(IMAGE_FILES):
    ...
    print(
        ...
        f'{results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_HIP].z})'
        + "\n" +
        f'Right Knee: ('
        ...
        f'{results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_KNEE].z})'
    )
